  ...
  return (
    <div className="bg-primary/6 h-full">
      ...
      <div className="w-[1200px] h-full absolute right-0 bottom-0">
       {/* {bg img } */}
       <div className="bg-none xl:bg-explosion xl:bg-cover xl:bg-right xl:bg-no-repeat w-full h-full absolute mix-blend-color-dodge translate-z-0 opacity-30"> image</div>
      </div>
    </div>
  );
};
